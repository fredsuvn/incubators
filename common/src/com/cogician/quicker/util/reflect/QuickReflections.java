...
public class QuickReflections {
     ...
     * @since 0.0.0
     */
    public static @Nullable Object getValue(Object inst, String name) throws ReflectionException {
     ...
     * @since 0.0.0
     */
    public static @Nullable Object getValue(Class<?> cls, String name) throws ReflectionException {
    ...
    public static @Nullable Object getValue(Class<?> cls, @Nullable Object inst, String name, boolean supportGetter)
        ...
        if (f == null) {
            if (!supportGetter) {
                throw new ReflectionException(new NoSuchFieldException(name));
            }
     ...
     * @since 0.0.0
     */
    public static void setValue(Object inst, String name, @Nullable Object value) throws ReflectionException {
     ...
     * @since 0.0.0
     */
    public static void setValue(Class<?> cls, String name, @Nullable Object value) throws ReflectionException {
    ...
    public static void setValue(Class<?> cls, @Nullable Object inst, String name, @Nullable Object value,
            boolean supportGetter) throws ReflectionException {
        Field f = getField(cls, name);
        if (f == null) {
            if (!supportGetter) {
                throw new ReflectionException(new NoSuchFieldException(name));
    ...
    public static @Nullable Object invoke(Class<?> cls, @Nullable Object inst, String name,
            @Nullable Class<?>[] parameterTypes, @Nullable Object[] args) throws ReflectionException {
        Method m = getMethod(cls, name, parameterTypes);
        if (m == null) {
            throw new ReflectionException(new NoSuchMethodException(buildMethodString(cls, name, parameterTypes)));
        }
    ...
    public static @Nullable Object invoke(Class<?> cls, @Nullable Object inst, String name, @Nullable Object[] args)
        ...
        if (m == null) {
            throw new ReflectionException(new NoSuchMethodException(buildMethodString(cls, name,
     ...
     * @since 0.0.0
     */
    public static Object invoke(Object inst, String name, @Nullable Object... args) throws ReflectionException {
     ...
     * @since 0.0.0
     */
    public static Object invoke(Class<?> cls, String name, @Nullable Object... args) throws ReflectionException {
