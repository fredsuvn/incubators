 ...
 * </p>
 * <p>
 * This interface can built by {@linkplain QLogger.Builder}. The builder will built an instance which output one place.
 * Using {@linkplain #multiLogger(List)} can get an instance which can output to more places.
 * </p>
 * <p>
...
public interface QLogger {
     ...
     * @since 0.0.0
     */
    public static QLogger multiLogger(List<QLogger> list) {
        return new QLogger() {

            private List<QLogger> loggers = Collections.unmodifiableList(list);
    ...
    /**
     * <p>
     * Builder of {@linkplain QLogger}. Default configurations are uniformed or null. Logging format must be set if
     ...
     */
    public static class Builder implements Buildable<QLogger> {
         ...
         * </p>
         * <p>
         * Log format support placeholder {@linkplain QuickPlaceholderResolver#defaultLogResolver()}. Here are all meanings:
         * <table>
         * <th>Placeholder</th>
         * <th>Meaning</th>
         * <tr>
        ...
        /**
         * <p>
         * Builds a {@linkplain QLogger}. Log format must be set if specified output is non-null.
         * </p>
         * 
         * @return a {@linkplain QLogger}
         * @throws IllegalArgumentException
         *             if log format is null but specified output is non-null
         * @since 0.0.0
         */
        @Override
        public QLogger build() throws IllegalArgumentException {
        ...
        private static String toLevelString(int level) {
            switch (level) {
                ...
                default: {
                    String preffix;
                    if (level < QLogger.DEBUG) {
                        preffix = "ALL";
                    } else if (level < QLogger.INFO) {
                        preffix = "DEBUG";
                    } else if (level < QLogger.WARN) {
                        preffix = "INFO";
                    } else if (level < QLogger.ERROR) {
                        preffix = "WARN";
                    } else if (level < QLogger.FATAL) {
                        preffix = "ERROR";
                    } else {
                        preffix = "FATAL";
                    }
