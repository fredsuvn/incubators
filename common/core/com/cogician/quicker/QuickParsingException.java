 ...
 */
public class QuickParsingException extends CommonRuntimeException {
     ...
     * @since 0.0.0
     */
    public QuickParsingException(final String message) {
        super(message);
    }
     ...
     * @since 0.0.0
     */
    public QuickParsingException(final Throwable cause) {
        super(cause);
    }
     ...
     * @since 0.0.0
     */
    public QuickParsingException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 0.0.0
     */
    public QuickParsingException(String message, int index) {
