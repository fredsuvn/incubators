...
public class Calculator implements Cloneable {
     ...
     * @since 0.0.0
     */
    public BigDecimal calculate(String expr) throws NullPointerException, QuickParsingException {
        ...
        for (int i = 0; i < stack.size();) {
            ...
            if (obj instanceof BigDecimal) {
                ...
                throw new QuickParsingException("Unknown parsing exception: " + expr);
            }
        }
        if (stack.size() != 1) {
            throw new QuickParsingException("Unknown parsing exception: " + expr);
