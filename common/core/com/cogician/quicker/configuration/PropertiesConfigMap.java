package com.cogician.quicker.configuration;
...
/**
 * <p>
 * Using {@linkplain Properties} to implement {@linkplain QConfiguration}. This class will support placeholder for its value
 ...
 */
@ThreadSafe
public class PropertiesConfigMap implements QConfiguration {
    ...
    private final QuickExpressionParser resolver;
     ...
     * @since 0.0.0
     */
    public PropertiesConfigMap(URI uri, @Nullable QuickExpressionParser resolver)
     ...
     * @since 0.0.0
     */
    public PropertiesConfigMap(String fileName, @Nullable QuickExpressionParser resolver)
     ...
     * @since 0.0.0
     */
    public PropertiesConfigMap(InputStream in, @Nullable QuickExpressionParser resolver)
            throws NullPointerException, ReadException {
        this.uri = null;
        this.resolver = resolver;
        load(in);
    ...
    @Override
    public QConfiguration toReadOnly() {
