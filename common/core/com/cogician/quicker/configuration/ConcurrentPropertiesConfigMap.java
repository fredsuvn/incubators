...
public class ConcurrentPropertiesConfigMap extends PropertiesConfigMap {
     ...
     * @since 0.0.0
     */
    public ConcurrentPropertiesConfigMap(URI uri, @Nullable QuickExpressionParser resolver)
     ...
     * @since 0.0.0
     */
    public ConcurrentPropertiesConfigMap(String fileName, @Nullable QuickExpressionParser resolver)
            throws NullPointerException, ReadException, IllegalArgumentException {
     ...
     * @since 0.0.0
     */
    public ConcurrentPropertiesConfigMap(InputStream in, @Nullable QuickExpressionParser resolver)
            throws NullPointerException, ReadException {
        super(in, resolver);
    }
